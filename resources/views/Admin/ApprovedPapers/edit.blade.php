        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{URL::to('admin/approved-paper/'.$paper->id.'/updatenew')}}" enctype="Multipart/Form-data" method="post" class="form-material form-horizontal">
                            <div class="form-body">
                                ...
                                {{csrf_field()}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="select2 form-control custom-select" name="volume" required>
                                                ...
                                                <option value="{{$item->name}}" {{ $paper->volume == $item->name ? 'selected' : '' }}>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <select class="select2 form-control custom-select" name="issue" required>
                                                ...
                                                <option value="{{$item->name}}" {{ $paper->issue == $item->name ? 'selected' : '' }}>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="page_number" placeholder="Enter Page Number" value="{{$paper->page_no}}" required>
                                            </div>  
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label text-right col-md-2">Author Name</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="author_name" placeholder="Enter Author Name" value="{{$paper->author}}" required>
                                            </div>  
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label text-right col-md-2">Name</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="name" placeholder="Enter Name" value="{{$paper->name}}" required>
                                            </div>  
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="email" placeholder="Enter Email" value="{{$paper->email}}" required>
                                            </div>  
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="mobile" placeholder="Enter Mobile" value="{{$paper->mobile}}" required>
                                            </div>  
                                        </div>
                                    ...
                                    <!--/span-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" name="paper_title" rows="3" placeholder="Enter Paper Title" required>{{$paper->title}}</textarea>
                                            </div>
                                        </div>
