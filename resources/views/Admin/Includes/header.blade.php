...
<head>
    ...
    <title>IJARST Admin Dashboard</title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
...
<body class="skin-green-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Ijarst</p>
        </div>
    </div>
    <!-- ============================================================== -->
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" style="margin-left: 40px;font-size: 30px;" href="{{ url('/admin/dashboard') }}">
                        <!-- Logo icon --><b>
                        ...
                        <!--End Logo icon -->
                        <!-- Logo text --><span style="text-align: center;">
                         <!-- dark Logo text -->
                         {{-- <img src="../assets/images/logo-text.png" alt="homepage" class="dark-logo" /> --}}
                         <!-- Light Logo text -->    
                         IJARST
                         {{-- <img src="{{ url('frontend/images/logo.jpg') }}" class="light-logo" alt="homepage" /> --}}
                     </span> 
                 </a>
