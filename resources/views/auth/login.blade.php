...
<link rel="icon" type="image/png" sizes="16x16" href="{{url('assets/images/favicon.png')}}">
    <title>Ijiemr Admin Dashboard</title>
        ...
        <div class="login-register" style="background-image:url(../public/assets/images/background/login-register.jpg);">
            <div class="container">
                <div class="row justify-content-center" style="margin-top: 10%;">
                    <div class="col-md-8">
                        <div class="card" style="width: auto;max-width: 500px;margin: 0 auto;">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('login') }}" class="form-horizontal form-material text-center" id="loginform">
                                    ...
                                    {{-- <a href="javascript:void(0)" class="db"><img src="{{url ('assets/images/s.png')}}" alt="Home" style="height: 50px;" /><br/><h3>Urban Live</h3></a> --}}
