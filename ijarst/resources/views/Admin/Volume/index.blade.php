    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Volume</h4>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card ">
                    <div class="card-header bg-info">
                        <h4 class="m-b-0 text-white">Add New Volume</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{URL::to('admin/volume')}}" enctype="Multipart/Form-data" method="post" class="form-material form-horizontal">
                            <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-2">Volume</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="name" placeholder="Enter Volume" required>
                                </div>  
                            </div>
                            </div>
                            <hr>
                ...
                <div class="card ">
                    <div class="card-header bg-info">
                        <h4 class="m-b-0 text-white">Edit Volume</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{URL::to('admin/volume/'.$volume->id)}}" enctype="Multipart/Form-data" method="post" class="form-material form-horizontal">
                            {{ method_field('PATCH') }} 
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-2">Volume</label>
                                <div class="col-md-10">
                                <input type="text" class="form-control" name="name" placeholder="Enter Volume" value="{{$volume->name}}" required>
                                </div>  
                            </div>
                            </div>
                            <hr>
