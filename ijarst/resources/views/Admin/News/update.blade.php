            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">View News Update</a>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{URL::to('admin/news/'.$news->id)}}" enctype="Multipart/Form-data" method="post" class="form-material form-horizontal">
                            {{ method_field('PATCH') }}
                            <div class="form-body">
                            ...
                            @endif
                                ...
                                {{csrf_field()}}
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="title" placeholder="Enter Title" value="{{$news->title}}" required>
                                            </div>  
                                        </div>
                                    ...
                                    <!--/span-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" name="desc" rows="3" placeholder="Enter Description" required>{{$news->desc}}</textarea>
                                            </div>
                                        </div>                               
