            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">News Updates List</h4>
                                    ...
                                    <table id="myTable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{url('admin/news/'.$val->id.'/edit')}}"><button type="submit" class="btn waves-effect waves-light btn-outline-info"><i class="ti-pencil"></i></button></a></td>
                                                <td>
                                                    <form action="{{url('admin/news/'.$val->id)}}" method="post">
                                                        {{ method_field('DELETE') }}
