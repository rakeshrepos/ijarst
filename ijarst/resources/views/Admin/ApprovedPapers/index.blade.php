            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Paper List Submited By Admin</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Approved Paper List</li>
                            </ol>
                            <a href="{{url('admin/approved-paper/create')}}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15">
                                + Add New</button></a>
                        </div>
                    </div>
                </div>
