    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Issue</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">Issue & Volume</a>
                        </li>
                        <li class="breadcrumb-item active">Manage Issue</li>
                    </ol>
                    {{-- <a href="{{url('admin/news/create')}}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15">
                        + Add New</button></a> --}}
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card ">
                    <div class="card-header bg-info">
                        <h4 class="m-b-0 text-white">Add New Issue</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{URL::to('admin/issue')}}" enctype="Multipart/Form-data" method="post" class="form-material form-horizontal">
                            <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-2">Issue</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="name" placeholder="Enter Issue" required>
                                </div>  
                            </div>
                            </div>
                            <hr>
                ...
                <div class="card ">
                    <div class="card-header bg-info">
                        <h4 class="m-b-0 text-white">Edit Issue</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{URL::to('admin/issue/'.$issue->id)}}" enctype="Multipart/Form-data" method="post" class="form-material form-horizontal">
                            {{ method_field('PATCH') }} 
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-2">Issue</label>
                                <div class="col-md-10">
                                <input type="text" class="form-control" name="name" placeholder="Enter Issue" value="{{$issue->name}}" required>
                                </div>  
                            </div>
                            </div>
                            <hr>
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit" class="btn waves-effect waves-light btn-rounded btn-success">Update</button>
                                                <button type="reset" class="btn waves-effect waves-light btn-rounded btn-light">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Manage Issue</h4>
                        {{-- @if(session()->has('success'))
                        <div class="alert alert-success alert-rounded">{{ session()->get('success') }}
                             <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                         </div>
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="myTable"
                                ...
                                <tbody>
                                    ...
                                    @foreach($issue_all as $val)
                                    <tr>
                                        <td>{{$loop->iteration }}.</td>
                                        <td>{{$val->name }}</td>
                                        <td><a href="{{url('admin/volume/'.$val->id.'/edit')}}"><button type="submit" class="btn waves-effect waves-light btn-outline-info"><i class="ti-pencil"></i></button></a></td>
                                        <td>
                                            <form action="{{url('admin/volume/'.$val->id)}}" method="post">
                                                {{ method_field('DELETE') }}
